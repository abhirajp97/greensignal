...
*Last updated: 2026-08-04 — walk-forward purchase simulations added to notebooks 01 (re-executed), 02, and 03; reader's guides added/updated for notebooks 01, 02, 03, and 04 (`docs/notebook_0{1,2,3,4}_guide.md`; a notebook 05 guide/walk-forward pass was built in the same session but discarded on merge with `main`, since notebook 05 had been independently rebuilt around SPI — see `[0.16.0]`/`[0.25.0]` in `CHANGELOG.md`)*
