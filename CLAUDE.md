...
- Full 5-signal composite: **4.54% forward prescience** (Phase 0 synthetic) — must be re-run now that L1, **L2a (true vintage, dual gate)**, **L2b (on the ~14m El Niño lead)** and **L3 (SPI flowering deficit, confirming)** clear their gates; only L5 remains a failed/weak signal. Reweighting likely needed.
...
4. ← **NEXT:** Rebuild Phase 0 composite backtest (notebook 06) on real data — confirm rank order and reweight. L1, L2a (true vintage, dual gate), L2b (~14m El Niño lead) and L3 (SPI flowering deficit) clear their gates; L3 is a confirming amplifier; L5 is the lone failed signal (decide role or drop)
