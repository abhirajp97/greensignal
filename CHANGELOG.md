...
- Walk-forward purchase simulation for notebook 04 (L2a) — not yet added; notebooks 01/02/03 have one as of [0.25.0] below. An equivalent was also built for notebook 05 (CHIRPS) in that same session but discarded on merge, since notebook 05 had been independently rebuilt around SPI in the meantime ([0.16.0], 2026-07-02) — re-deriving a walk-forward test against the newer SPI methodology is still open
